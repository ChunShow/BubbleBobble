...
enum TEXTURE_BLOCK { _BRICK_RED, _BRICK_BLUE, _BRICK_BLACK, _FIELD_SKY, _GAMEOVER, _TITLE, _GAMEWIN, _HELP, _LEADERBOARD, _TIME, _SCORE, _APPLE, _HEART, _SPEED, _BUBBLE, _DOUBLE };
